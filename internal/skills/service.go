...
func (s *Service) ensureAgent(ctx context.Context, agentID string) (*agent2.Agent, error) {
...
func (s *Service) deploySkillToWorkspace(agentValue *agent2.Agent, record catalogRecord) error {
