...
// StructuredSessionKeyError 对齐 Python 侧的 422 校验错误。
...
// BuildRoomSessionKey 兼容旧调用名。
func BuildRoomSessionKey(conversationID string) string {
	return BuildRoomSharedSessionKey(conversationID)
}
