...
const CONNECTOR_ICON_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  amap: { bg: "bg-emerald-50", text: "text-emerald-700" },
  didi: { bg: "bg-orange-50", text: "text-orange-700" },
  dingtalk: { bg: "bg-blue-50", text: "text-blue-700" },
  "tencent-docs": { bg: "bg-indigo-50", text: "text-indigo-700" },
  yuque: { bg: "bg-emerald-50", text: "text-emerald-700" },
