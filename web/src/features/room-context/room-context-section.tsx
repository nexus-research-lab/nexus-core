    ...
    <>
      <section className="px-3 py-4">
        ...
        <div className="mt-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="workspace-chip rounded-full px-3 py-1 text-[11px] font-semibold text-slate-700/58 transition-colors hover:text-slate-950 focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-1"
        ...
        {contextualFiles.length > 0 && (
          <div className="mt-3">
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-700/46">
            快速打开
          </p>
            ...
            {contextualFiles.map((file) => {
              ...
              return (
                <button
                  key={file.path}
                  className={cn(
                    "flex w-full items-center gap-3 rounded-[16px] px-3 py-2 text-left transition-all duration-300",
                    isActive ? "border border-white/28 bg-white/18" : "border border-transparent hover:bg-white/10",
                  )}
                  onClick={() => on_open_workspace_file(file.path)}
                  type="button"
                >
                  <div
                    className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-white/24 bg-white/18 text-slate-700/60">
        ...
        {is_file_explorer_visible && (
          ...
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-700/46">
            ...
            <div className="max-h-[220px] overflow-y-auto rounded-[16px] border border-white/28 bg-white/18 p-2 custom-scrollbar">
