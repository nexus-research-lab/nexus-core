...
import { FilePlus, FolderOpen, FolderPlus, FolderTree, GripVertical, LoaderCircle, Upload, } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div
              className="mb-3 inline-flex min-w-0 items-center gap-2 rounded-full border border-(--divider-subtle-color) px-3 py-1.5 text-[12px] text-(--text-default)">
              {focused_directory_path ? (
