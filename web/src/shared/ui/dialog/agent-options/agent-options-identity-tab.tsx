  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
      ...
      <div className="space-y-2">
        <label className="text-[11px] font-semibold text-[color:var(--text-muted)]">Avatar</label>
        <div className="flex items-center gap-4">
          <div className="dialog-card flex h-16 w-16 items-center justify-center rounded-full text-primary">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className="dialog-input rounded-xl flex h-11 w-full px-4 py-2 text-sm text-[color:var(--text-strong)] placeholder:text-[color:var(--text-soft)] focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-all"
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="dialog-input rounded-2xl flex min-h-[80px] w-full resize-y px-4 py-3 text-sm text-[color:var(--text-strong)] placeholder:text-[color:var(--text-soft)] focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-all"
          rows={3}
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <select
            ...
            className="dialog-input rounded-xl flex h-11 w-full appearance-none px-4 py-2 text-sm text-[color:var(--text-strong)] focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 transition-all"
          >
